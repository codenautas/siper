-- =================================================================================
-- PROCEDIMIENTO PRINCIPAL (siper.procesar_fichadas) - Transaccional (No DBLINK)
-- Utiliza Best-Effort (BEGIN/EXCEPTION por elemento) para permitir fallos parciales 
-- y ahora almacena el JSON de fallas COMPLETO y sin truncar en end_status.
-- NOTA: Se usa TRANSLATE(string, chr(10), ' ') para limpiar saltos de línea.
-- =================================================================================
