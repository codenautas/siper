...
$BODY$
  SELECT
      ...
      CASE WHEN trabajable OR nr_corridos THEN 
        coalesce(CASE WHEN fichadas_consolidadas AND nr_requiere_fichadas AND inicia_fichada <= fecha THEN fv_cod_nov ELSE null END, nr_cod_nov, cod_nov_pred_fecha) 
