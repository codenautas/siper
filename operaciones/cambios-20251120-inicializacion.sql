...
check (inicializacion in ('LICORD', 'LICMAT', 'CONST'));
...
update siper.cod_novedades set inicializacion = 'CONST' where cod_nov = '11';
...
update siper.cod_novedades set inicializacion = 'CONST' where cod_nov = '21';
update siper.cod_novedades set inicializacion_limite = 10 where cod_nov = '23';
update siper.cod_novedades set inicializacion = 'CONST' where cod_nov = '23';
update siper.cod_novedades set inicializacion_limite = 4 where cod_nov = '121';
update siper.cod_novedades set inicializacion = 'CONST' where cod_nov = '121';
update siper.cod_novedades set inicializacion_limite = 1 where cod_nov = '124';
update siper.cod_novedades set inicializacion = 'CONST' where cod_nov = '124';
update siper.cod_novedades set inicializacion_limite = 1 where cod_nov = '126';
update siper.cod_novedades set inicializacion = 'CONST' where cod_nov = '126';
update siper.cod_novedades set inicializacion_limite = 10 where cod_nov = '155';
update siper.cod_novedades set inicializacion = 'CONST' where cod_nov = '155';
update siper.cod_novedades set inicializacion_limite = 5 where cod_nov = '156';
update siper.cod_novedades set inicializacion = 'CONST' where cod_nov = '156';
update siper.cod_novedades set inicializacion_limite = 1 where cod_nov = '157';
update siper.cod_novedades set inicializacion = 'CONST' where cod_nov = '157';