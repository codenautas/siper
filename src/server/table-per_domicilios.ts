...
export function per_domicilios(context: TableContext): TableDefinition{
    ...
    return {
        ...
        fields: [
            ...
            tipo_domicilio,
            provincia,
            {...comuna_partido        , label: 'comuna'  , description: 'código de COMUNA o de PARTIDO en el caso de provincia' },
            {...barrio_localidad      , label: 'barrio'  , description: 'código de BARRIO o de LOCALIDA en el caso de provincia'},
            ...
            {name: 'coordenada_x'     ,typeName:'decimal', dataLength:11, dataDecimals:7, editable:false},
            {name: 'coordenada_y'     ,typeName:'decimal', dataLength:11, dataDecimals:7, editable:false},
            {name: 'obs_geo'          ,typeName:'text'   , title: 'observaciones geo', editable:false },
            {name: 'fecha_codificacion', typeName:'date' , editable:false },
            {name: 'fecha_envio_codificacion', typeName:'date', editable:false },
        ],
        primaryKey: [idper.name, 'nro_item'],
        foreignKeys: [
            {references: 'personas'   , fields: [idper.name], displayFields:['apellido', 'nombres', 'activo']},
