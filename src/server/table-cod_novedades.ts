...
export function cod_novedades(context:TableContext):TableDefinition{
    ...
    return {
        ...
        fields:[
            ...
            {name: 'pierde_presentismo', typeName: 'boolean', nullable: true },
            {name: 'cuenta_horas', typeName: 'boolean', nullable: true },
            {name: 'requiere_fichadas', typeName: 'boolean', nullable: true },
            {name: 'requiere_entrada', typeName: 'boolean', nullable: true },
            {name: 'umbral_posterior_entrada', typeName: 'integer', nullable: true },
            {name: 'umbral_anterior_salida', typeName: 'integer', nullable: true },
            {name: 'necesita_verificacion_manual', typeName: 'boolean', nullable: true },
            {name: 'eximido_fichar', typeName: 'boolean', nullable: true },
        ],
