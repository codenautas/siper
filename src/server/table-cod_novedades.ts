...
export function cod_novedades(context:TableContext):TableDefinition{
    ...
    return {
        ...
        fields:[
            ...
            {name: 'requiere_fichadas',            typeName: 'boolean' },
            {name: 'requiere_entrada',             typeName: 'boolean' },
            {name: 'umbral_posterior_entrada',     typeName: 'integer' },
            {name: 'umbral_anterior_salida',       typeName: 'integer' },
            ...
            {name: 'inicializacion' , typeName: 'text', description:'si es un numero es el tope, sino una lista de algoritmos'},
        ],
        ...
        constraints:[
            ...
            {constraintType:'check' , expr:`inicializacion in ('LICORD', 'LICMAT') or inicializacion ~ '^\\d+$'`, consName:'inicializacion numero o algoritmo'},
        ],
        foreignKeys:[
