...
export function presentismo(context: TableContext): TableDefinition {
    return {
        ...
        fields: [
            ...
            { name: "suma_horas"                , typeName: "interval"  , format:'hm', description: "suma de horas de los días considerados para el cálculo de promedio"},
            { name: "horas_esperadas"           , typeName: "interval"  , format:'hm', description: "cantidad de horas que correspondía trabajar en los días considerados" },
            { name: "promedio_horas"            , typeName: "interval"  , format:'hm', description: "promedio de horas trabajados por día (en los días considerados)"},
            { name: "promedio_esperado"         , typeName: "interval"  , format:'hm', description: "promedio de horas que correspondía trabajar en los días considerados" },
            { name: "saldo_horas"               , typeName: "interval"  , format:'hm', description: "saldo entre las horas sumadas y las esperadas" },
