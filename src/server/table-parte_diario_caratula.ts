...
//import {grupo_parte_diario} from "./table-grupos_parte_diario";

export const sqlParteDiarioCaratula= (params:{idper?:string})=> `
                      SELECT grupo_padre, descripcion, count(*) cantidad
                      ...
                      WITH RECURSIVE hierarchy AS (
                        ...
                        WHERE p.activo ${params.idper? ` and p.idper = ${sqlTools.quoteLiteral(params.idper)} `:''}
                        UNION ALL
