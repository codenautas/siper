            ...
            <div className="legajo-seccion">
                <div className="legajo-grupo">
                    ...
                    <div className="legajo-campo">
                        ...
                        <div className="legajo-valor">{persona.situacion_revista__descripcion || '-'}</div>
                    </div>
                </div>
                <div className="legajo-grupo">
                    <div className="legajo-campo">
